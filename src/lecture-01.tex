...
dominates the other, and the deck's legend marks both admissible (\xref{1.5.12}). A caution
...
(Figure~\xref{1.5.13}). To pick a single method, something must say which regions of $\Theta$
...
the collapse that turned random losses into the risk (\xref{1.5.9}) can be run once more, one
