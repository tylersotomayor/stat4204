...
\end{Obj}
\begin{Prf}{1.4.2}{Proof by Regrouping of the Unconscious-Statistician Formula (discrete case).}{}
...
\[ \E\{\E\{Y\mid X\}\} \;=\; \E\{Y\}. \]
\end{Obj}
\begin{Prf}{1.4.6}{Proof by Conditioning of the Iterated-Expectations Identity (discrete case).}{}
